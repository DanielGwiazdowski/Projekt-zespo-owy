...
namespace Projekt_zespołowy.Views
{
    public partial class CartPage : Page
    {
        ...
        private void Clear_Click(object sender, RoutedEventArgs e) => Store.Clear();
        ...
        public class CartStore : INotifyPropertyChanged
        {
            ...
            public CartStore()
            {
                Items.CollectionChanged += (s, e) => RaiseTotals();
            }
            ...
            public void RaiseTotalsPublic() => RaiseTotals();
